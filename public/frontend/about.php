      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          <div class="col-lg-6">
            ...
            <p class="about-description">Zeps Media hadir untuk membantu Anda membangun kredibilitas dan meningkatkan visibilitas di dunia digital melalui layanan pemasaran media sosial yang lengkap dan terpercaya.</p>
          </div>
          <div class="col-lg-6">
            <p class="about-text">Kami menyediakan berbagai layanan seperti jual followers, subscribers, like, komentar, view, hingga akun siap pakai untuk berbagai platform populer seperti Instagram, YouTube, TikTok, dan lainnya.</p>
            <p class="about-text">Dengan tim profesional dan sistem otomatis, kami memastikan proses cepat, aman, dan efektif untuk semua kebutuhan social media marketing Anda.</p>
          </div>
        </div>
        ...
        <div class="row features-boxes gy-4 mt-3">
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="200">
            <div class="feature-box">
              ...
              <p>Layanan kami disesuaikan dengan kebutuhan bisnis Anda agar tepat sasaran dan memberikan hasil optimal di setiap platform.</p>
            </div>
          </div>

            ...
            <div class="login-register-wraper">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane fade show active" id="login-register-login-form" role="tabpanel">
                  <form>
                    <div class="mb-4">
                      <label for="login-register-login-email" class="form-label">Username / Email</label>
                ...
                <div class="tab-pane fade" id="login-register-registration-form" role="tabpanel">
                  <form>
                    <div class="row g-3">
                      <div class="col-sm-6">
                        <div class="mb-4">
                          <label for="login-register-reg-firstname" class="form-label">Nama Depan </label>
                      ...
                      <div class="col-sm-6">
                        <div class="mb-4">
                          <label for="login-register-reg-lastname" class="form-label">Nama Belakang</label>
                      ...
                      <div class="col-12">
                        <div class="mb-4">
                          <label for="login-register-reg-email" class="form-label">Alamat Email</label>
                      ...
                      <div class="col-12">
                        <div class="mb-4">
                          <label for="login-register-reg-confirm-password" class="form-label">Konfirmasi Password</label>

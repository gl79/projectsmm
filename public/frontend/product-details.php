            ...
            <div class="product-images">
              <div class="main-image-container mb-3">
                <div class="image-zoom-container">
                  <img src="assets/img/product/instagram.webp" alt="Product Image" class="img-fluid main-image drift-zoom" id="main-product-image" data-zoom="assets/img/product/product-details-1.webp">
                </div>
              </div>
              ...
              <div class="product-thumbnails">
                <div class="swiper product-thumbnails-slider init-swiper">
                  ...
                  <div class="swiper-wrapper">
                    <div class="swiper-slide thumbnail-item active" data-image="assets/img/product/instagram.webp">
                      <img src="assets/img/product/instagram.webp" alt="Product Thumbnail" class="img-fluid">
                    </div>
                    <div class="swiper-slide thumbnail-item" data-image="assets/img/product/tiktok.png">
                      <img src="assets/img/product/tiktok.png" alt="Product Thumbnail" class="img-fluid">
                    </div>
                    <div class="swiper-slide thumbnail-item" data-image="assets/img/product/vidio.png">
                      <img src="assets/img/product/vidio.png" alt="Product Thumbnail" class="img-fluid">
                    </div>
                    <div class="swiper-slide thumbnail-item" data-image="assets/img/product/pornhub.png">
                      <img src="assets/img/product/pornhub.png" alt="Product Thumbnail" class="img-fluid">
                    </div>
                    <div class="swiper-slide thumbnail-item" data-image="assets/img/product/spotify.png">
                      <img src="assets/img/product/spotify.png" alt="Product Thumbnail" class="img-fluid">
                    </div>
                  </div>
          ...
          <div class="col-lg-6" data-aos="fade-left" data-aos-delay="200">
            <div class="product-info">
              <div class="product-meta mb-2">
                <span class="product-category">Instagram</span>
              ...
              <h1 class="product-title">Follower Likes Instagram 30 Day</h1>

              <div class="product-price-container mb-4">
                <span class="current-price">IDR 249.000</span>
...
-->
              ...
              <div class="product-sizes mb-4">
                <h6 class="option-title">Garansi :</h6>
                <div class="size-options">
                  <div class="size-option" data-size="S">3</div>
                  <div class="size-option active" data-size="M">15</div>
                  <div class="size-option" data-size="L">30</div>
                </div>
                <span class="selected-option">15</span>
              </div>
              ...
              <div class="product-actions">
                <button class="btn btn-primary add-to-cart-btn">
                  <i class="bi bi-cart-plus"></i> Masukan Keranjang
                </button>
